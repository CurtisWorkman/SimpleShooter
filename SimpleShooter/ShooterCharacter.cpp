...
void AShooterCharacter::PickUpHealth(float HealthAmount)
{
	UE_LOG(LogTemp, Warning, TEXT("Healthy %f"), HealthAmount);
	float HealthToApply = FMath::Min(HealthAmount, (MaxHealth - Health));
	Health += HealthToApply;
}
